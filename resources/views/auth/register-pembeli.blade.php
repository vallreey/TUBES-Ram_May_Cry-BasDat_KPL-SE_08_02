...
<head>
  ...
  <title>Daftar Pembeli | Ram May Cry</title>
              ...
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-info shadow-info border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">
                    <i class="fa fa-shopping-cart me-2"></i> Daftar sebagai Pembeli
                  </h4>
              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('register.post') }}">
                  ...
                  <div class="text-center">
                    <button type="submit" class="btn bg-gradient-info w-100 mt-3 mb-2">Daftar sebagai Pembeli</button>
                  </div>

                  <p class="text-sm text-center mt-2">
                    Ingin daftar sebagai peternak?
                    <a href="{{ route('register', ['role' => 'peternak']) }}" class="text-primary text-gradient font-weight-bold">Klik di sini</a>
                  </p>
